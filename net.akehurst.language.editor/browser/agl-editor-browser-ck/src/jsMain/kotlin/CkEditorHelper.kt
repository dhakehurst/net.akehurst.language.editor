...
//    const val ATTRIBUTE_NAME_STYLE_FONT_BACK_COLOUR = "agl_back_color"
    ...
    val ATTRIBUTE_SET_SYNTAX_STYLE = setOf(
        ATTRIBUTE_NAME_STYLE_FONT_FORE_COLOUR, ATTRIBUTE_NAME_STYLE_FONT_BACK_COLOUR,
    ...
    private fun attributeToElement(ckEditor: ck.core.editor.Editor, attributeName: String, a2e: dynamic) {
    ...
    private fun getFormattingAttributeNames(item: ck.engine.model.Item, schema: ck.engine.model.Schema): List<String> {
