...
object TestLanguageSql {
    ...
    val languageDefinition by lazy {
        Agl.languageDefinitionFromStringSimple(
            languageId,
            grammarDefinitionStr = GrammarString(TestLanguageSql.GRAMMAR),
            referenceStr = CrossReferenceString(TestLanguageSql.CROSS_REFERENCE),
            styleStr = StyleString(TestLanguageSql.STYLE)
        )
    }
